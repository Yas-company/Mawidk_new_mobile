...
List<Option> allDiseases = [
  ...
  Option(id: 3, optionText: "أمراض القلب التاجية", optionTextEn: "Coronary Artery Disease"),
  Option(id: 4, optionText: "فشل القلب المزمن", optionTextEn: "Chronic Heart Failure"),
  Option(id: 5, optionText: "اضطراب نظم القلب المزمن", optionTextEn: "Chronic Arrhythmia"),
  Option(id: 6, optionText: "اضطرابات الغدة الدرقية", optionTextEn: "Chronic Thyroid Disorders"),
  Option(id: 7, optionText: "الربو", optionTextEn: "Chronic Asthma"),
  Option(id: 8, optionText: "الانسداد الرئوي المزمن", optionTextEn: "Chronic Obstructive Pulmonary Disease (COPD)"),
  Option(id: 9, optionText: "مرض الكلى المزمن", optionTextEn: "Chronic Kidney Disease"),
  Option(id: 10, optionText: "تليف الكبد", optionTextEn: "Liver Cirrhosis"),
  Option(id: 11, optionText: "التهاب الكبد المزمن", optionTextEn: "Chronic Hepatitis"),
  Option(id: 12, optionText: "الروماتويد", optionTextEn: "Rheumatoid Arthritis"),
  Option(id: 13, optionText: "هشاشة العظام", optionTextEn: "Osteoporosis"),
  Option(id: 14, optionText: "الذئبة الحمراء", optionTextEn: "Systemic Lupus Erythematosus"),
  Option(id: 15, optionText: "الصرع", optionTextEn: "Epilepsy"),
  Option(id: 16, optionText: "باركنسون", optionTextEn: "Parkinson's Disease"),
  Option(id: 17, optionText: "التصلب المتعدد", optionTextEn: "Multiple Sclerosis"),
  Option(id: 18, optionText: "الزهايمر", optionTextEn: "Alzheimer's Disease"),
  Option(id: 19, optionText: "فقر الدم المنجلي", optionTextEn: "Sickle Cell Anemia"),
  Option(id: 20, optionText: "الثلاسيميا", optionTextEn: "Thalassemia"),
  Option(id: 21, optionText: "الهيموفيليا", optionTextEn: "Hemophilia"),
  Option(id: 22, optionText: "الاكتئاب المزمن", optionTextEn: "Chronic Depression"),
  Option(id: 23, optionText: "اضطراب ثنائي القطب", optionTextEn: "Bipolar Disorder"),
  Option(id: 24, optionText: "الفصام", optionTextEn: "Schizophrenia"),
  Option(id: 25, optionText: "السمنة", optionTextEn: "Obesity"),
  Option(id: 26, optionText: "السرطان", optionTextEn: "Cancer"),
  Option(id: 27, optionText: "الإيدز", optionTextEn: "HIV/AIDS"),
  Option(id: 28, optionText: "الصدفية", optionTextEn: "Psoriasis"),
  Option(id: 29, optionText: "داء كرون", optionTextEn: "Crohn’s Disease"),
  Option(id: 30, optionText: "التهاب القولون التقرحي", optionTextEn: "Ulcerative Colitis"),
];
