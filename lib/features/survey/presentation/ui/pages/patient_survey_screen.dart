...
class PatientSurveyScreen extends StatefulWidget {
  ...
  const PatientSurveyScreen({super.key,required this.surveyBloc});
                        ...
                        return Expanded(
                          ...
                          !(widget.surveyBloc.validateCurrentPage())?null:() {
                            ...
                            widget.surveyBloc.add(NextPageEvent(controller:_controller));
                              ...
                              color:!(widget.surveyBloc.validateCurrentPage())?
                              AppColors.blackColor:AppColors.whiteColor,),

                              // Icon(Icons.arrow_forward,color:!(widget.surveyBloc.validateCurrentPage())?
                              // AppColors.blackColor:AppColors.whiteColor,),
