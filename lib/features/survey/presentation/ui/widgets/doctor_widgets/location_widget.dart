            ...
            child: Column(mainAxisSize:MainAxisSize.max,
              ...
              children: [
                ...
                DashedBorderContainer(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        PImage(
                          source: AppSvgIcons.location,
                        ),
                        const SizedBox(height: 12),
                        PText(title: 'حدد موقع عيادتك',
                          size: PSize.text16,
                        ),
                        Padding(
                          padding: const EdgeInsets.only(left:20,right:20,top:10,bottom:20),
                          child: PText(title:'يرجى تحديد موقع عيادتك على الخريطة لمساعدة المرضى في العثور عليك بسهولة',
                            fontColor:AppColors.grey200,size:PSize.text13,
                            alignText:TextAlign.center,),
                        ),
                        PButton(isFitWidth:true,title:'تحديد موقع العيادة',hasBloc:false,
                          onPressed:() {
                ...
                Padding(
                  ...
                  child: PTextField(hintText:'اكتب العنوان التفصيلي للعيادة ( مثال : شارع العليا ،مبنى رقم ٢٥ ، الطابق الثالث ، بجوار مركز المملكة )',
                    labelAbove: 'العنوان التفصيلي',labelAboveFontWeight: FontWeight.w600,feedback:(value) {
                ...
                Padding(
                  ...
                  child: PTextField(hintText:'أدخل اسم العيادة',
                    labelAbove: 'اسم العيادة',labelAboveFontWeight: FontWeight.w600,feedback:(value) {
                ...
                Padding(
                  ...
                  child: PText(title:'أيام العمل',size:  PSize.text14,),
                ),
                Padding(
                ...
                Row(children:[
                  Expanded(
                    child: PTextField(hintText:'',
                      labelAbove: 'رسوم الإستشارة',labelAboveFontWeight: FontWeight.w600,feedback:(value) {

                      },),
                  ),const SizedBox(width:10,),
                  Padding(
                    padding: const EdgeInsets.only(top:20,),
                    child: PText(title: 'ريال'),
                  )
                ],
                ),
