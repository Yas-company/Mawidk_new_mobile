class AllConsultationsResponseModel {
  final List<ConsultationData>? model;

  AllConsultationsResponseModel({
    this.model,
  });

  AllConsultationsResponseModel fromMap(Map<String, dynamic> map) {
    return AllConsultationsResponseModel(
      model: map['model'] != null
          ? List<ConsultationData>.from(
        (map['model']).map<ConsultationData?>(
              (x) => ConsultationData().fromMap(x as Map<String, dynamic>),
        ),
      ) : null,
    );
  }
...
class ConsultationData {
  ...
  ConsultationData fromMap(Map<String, dynamic> json) {
